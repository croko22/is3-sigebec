...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%"
			...
			color: #F0F0F0;"
                            ...
                            <a target="_blank" style="text-decoration: none;"
                                href="https://github.com/konsav/email-templates/"><img border="0" vspace="0"
                                    hspace="0" src="{{ asset('images/largo_color_negro.png') }}" width="100"
                                    height="30" alt="Logo" title="Logo"
                                    style="
				color: #000000;
	...
	max-width: 560px;"
			...
			font-family: sans-serif;"
                            class="header">
                            ¡Tu solicitud de beca ha sido recibida!
                        </td>
                    </tr>
			...
			font-family: sans-serif;"
                            class="subheader">
                            Disponible en nuestro sistema de becas.
                        </td>
                    </tr>
			...
			padding-top: 20px;"
                            class="hero"><a target="_blank" style="text-decoration: none;"
                                href="https://github.com/konsav/email-templates/"><img border="0" vspace="0"
                                    hspace="0"
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRswOeZXt_zpHJAtVI8UlSNB4_BJ-lFAFgQdQ&s"
			...
			padding-top: 25px;
			padding-bottom: 5px;"
                            class="button"><a href="https://github.com/konsav/email-templates/" target="_blank"
			...
			padding-top: 25px;"
					...
					color: #000000;"
                                            ...
                                            alt="H" title="Highly compatible" width="50" height="50">
                                    </td>
					...
					font-family: sans-serif;"
                                        class="paragraph">
                                        <b style="color: #333333;">Transparencia y Progreso</b><br />
                                        Puedes seguir el progreso de tu solicitud en nuestro portal en línea, donde
                                        también encontrarás más detalles sobre el proceso de selección.
                                    </td>
					...
					color: #000000;"
                                            src="https://raw.githubusercontent.com/konsav/email-templates/master/images/list-item.png"
                                            alt="D" title="Designer friendly" width="50" height="50">
                                    </td>
					...
					font-family: sans-serif;"
                                        class="paragraph">
                                        <b style="color: #333333;">Soporte y Asistencia</b><br />
                                        Nuestro equipo de soporte está disponible para responder cualquier pregunta o
                                        inquietud que puedas tener. No dudes en contactarnos si necesitas ayuda
                                        adicional.
                                    </td>
	...
	max-width: 560px;"
			...
			font-family: sans-serif;"
                            ...
                            Este correo electrónico fue enviado porque has solicitado participar en nuestro programa de
                            becas. Puedes cambiar tus preferencias de suscripción en cualquier momento.
